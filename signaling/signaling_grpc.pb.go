...
const (
	...
	SipService_AiEventReq_FullMethodName    = "/signaling.SipService/AiEventReq"
	SipService_OTAUpgradeReq_FullMethodName = "/signaling.SipService/OTAUpgradeReq"
)
...
type SipServiceClient interface {
	...
	AiEventReq(ctx context.Context, in *AIEventRequest, opts ...grpc.CallOption) (*AIEventAck, error)
	OTAUpgradeReq(ctx context.Context, in *OTAUpgradeRequest, opts ...grpc.CallOption) (*OTAUpgradeAck, error)
}
...
func (c *sipServiceClient) AiEventReq(ctx context.Context, in *AIEventRequest, opts ...grpc.CallOption) (*AIEventAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AIEventAck)
	err := c.cc.Invoke(ctx, SipService_AiEventReq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sipServiceClient) OTAUpgradeReq(ctx context.Context, in *OTAUpgradeRequest, opts ...grpc.CallOption) (*OTAUpgradeAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OTAUpgradeAck)
	err := c.cc.Invoke(ctx, SipService_OTAUpgradeReq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SipServiceServer interface {
	...
	AiEventReq(context.Context, *AIEventRequest) (*AIEventAck, error)
	OTAUpgradeReq(context.Context, *OTAUpgradeRequest) (*OTAUpgradeAck, error)
...
func (UnimplementedSipServiceServer) AiEventReq(context.Context, *AIEventRequest) (*AIEventAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AiEventReq not implemented")
}
func (UnimplementedSipServiceServer) OTAUpgradeReq(context.Context, *OTAUpgradeRequest) (*OTAUpgradeAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OTAUpgradeReq not implemented")
}
...
func _SipService_AiEventReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AIEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SipServiceServer).AiEventReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SipService_AiEventReq_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SipServiceServer).AiEventReq(ctx, req.(*AIEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SipService_OTAUpgradeReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OTAUpgradeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SipServiceServer).OTAUpgradeReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SipService_OTAUpgradeReq_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SipServiceServer).OTAUpgradeReq(ctx, req.(*OTAUpgradeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SipService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AiEventReq",
			Handler:    _SipService_AiEventReq_Handler,
		},
		{
			MethodName: "OTAUpgradeReq",
			Handler:    _SipService_OTAUpgradeReq_Handler,
		},
	},
